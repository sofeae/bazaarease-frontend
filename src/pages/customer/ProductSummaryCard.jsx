...
// export const ProductsSummaryCard = ({ product }) => {
    ...
    // console.log(product.amount.chosenQuantity);
...
//     const handleIncrement = () => {
//         dispatch(incrementProductAmount({index: index}));
//       };
    
//       const handleDecrement = () => {
//           dispatch(decrementProductAmount({ index: index}));
//       };

// console.log("hehe",product._id)
